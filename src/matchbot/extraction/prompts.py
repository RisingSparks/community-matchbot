...
- Limit extractions: Select a MAXIMUM of 3 contribution_types that the camp is EXPLICITLY asking for
  (do not tag tasks they are simply describing or offering as a service).
- Tag guidelines:
  - communal: Use ONLY if the post emphasizes strict shared living, mandatory communal meals,
    or a high time commitment. Do NOT use just because it's a camp.
  - camp_admin: Use for supply chain, spreadsheets, inventory, or organizing. Do NOT use for
    physical labor (use build) or driving (use transport).
...
- Camp operations discussion is null. Posts about camp logistics/admin, roster stress,
